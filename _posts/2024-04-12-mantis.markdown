...
We report the performance in 3 domains daily life, robotics, and comics. Results are shown in Table 3. Mantis-llava-7b-v1.1 
Additionally, we get 29.80% F1-score for the behavior recognition, which surpasses all other models except GPT-4. Our precision reaches 38.88% for the daily-life behavior recognition, which is the best across all the models, even better than GPT-4. This demonstrates our model's great capability to capture dynamic various across multiple image sequences.
