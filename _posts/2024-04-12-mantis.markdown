...
1. [Qbench2](https://arxiv.org/abs/2309.14181): Binary Question Answering
2. [Mementos](https://arxiv.org/abs/2401.10529): Multi-image captioning
3. Mantis-eval: Multi-choice Question Answering curated by ourselves 

### NLVR^2, Birds-to-words, and Mantis-eval
...
*Table 3: The performance of Mantis-bakLLaVA-7b on Mementos behavior recognition evaluation (F1-score). The highest performance of open-source LMMs, and close-source LMMs (GPT-4V and Gemini) are bold respectively in the table.*
